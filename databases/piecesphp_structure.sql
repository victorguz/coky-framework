...
CREATE TABLE `pcsphp_articles_categories` (`id` int(11) NOT NULL) ENGINE = InnoDB DEFAULT CHARSET = utf8 COLLATE = utf8_bin;
...
--
ALTER TABLE
`pcsphp_articles_categories_content`
ADD
PRIMARY KEY (`id`),
ADD
KEY `content_of` (`content_of`);

--
-- Indices de la tabla `pcsphp_articles_content`
--
ALTER TABLE
`pcsphp_articles_content`
ADD
PRIMARY KEY (`id`),
ADD
KEY `content_of` (`content_of`);
...
--
ALTER TABLE
`pcsphp_blackboard_news_messages`
ADD
PRIMARY KEY (`id`),
ADD
KEY `author` (`author`);
...
`pcsphp_articles`
ADD
CONSTRAINT `pcsphp_articles_ibfk_1` FOREIGN KEY (`author`) REFERENCES `pcsphp_users` (`id`),
ADD
CONSTRAINT `pcsphp_articles_ibfk_2` FOREIGN KEY (`category`) REFERENCES `pcsphp_articles_categories` (`id`);
...
`pcsphp_articles_categories_content`
ADD
CONSTRAINT `pcsphp_articles_categories_content_ibfk_1` FOREIGN KEY (`content_of`) REFERENCES `pcsphp_articles_categories` (`id`);
...
`pcsphp_articles_content`
ADD
CONSTRAINT `pcsphp_articles_content_ibfk_1` FOREIGN KEY (`content_of`) REFERENCES `pcsphp_articles` (`id`);
...
`pcsphp_shop_products`
ADD
CONSTRAINT `pcsphp_shop_products_ibfk_1` FOREIGN KEY (`brand`) REFERENCES `pcsphp_shop_brands` (`id`),
ADD
CONSTRAINT `pcsphp_shop_products_ibfk_2` FOREIGN KEY (`category`) REFERENCES `pcsphp_shop_categories` (`id`),
ADD
CONSTRAINT `pcsphp_shop_products_ibfk_3` FOREIGN KEY (`subcategory`) REFERENCES `pcsphp_shop_subcategories` (`id`);
...
`pcsphp_shop_subcategories`
ADD
CONSTRAINT `pcsphp_shop_subcategories_ibfk_1` FOREIGN KEY (`category`) REFERENCES `pcsphp_shop_categories` (`id`);
...
main.updated
FROM
pcsphp_articles AS main
INNER JOIN pcsphp_articles_content AS sub ON sub.content_of = main.id
);
