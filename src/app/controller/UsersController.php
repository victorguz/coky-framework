...
class UsersController extends AdminPanelController
{
    ...
    public function dataTablesRequestUsers(Request $req, Response $res, array $args)
    {
        ...
        $on_set_data = function ($element) {
            ...
            $edit_button = new HtmlElement('a', '<i class="icon edit"></i>');
            $edit_button->setAttribute('class', 'ui primary mini icon button');
    ...
    public function formCreateByType(Request $req, Response $res, array $args)
    {
        ...
        if (isset(UsersModel::getTypesUser()[$type])) {
            ...
            } elseif ($type == UsersModel::TYPE_USER_CLIENT) {

                $form = $this->render('usuarios/form-by-type/create/client/form', $data_form, false);
            } elseif ($type == UsersModel::TYPE_USER_EMPLOYEE) {

                $form = $this->render('usuarios/form-by-type/create/employee/form', $data_form, false);
            }
        ...
        if (!is_null($user->id)) {
            ...
            if (!$is_same) {
                ...
                if ($type == UsersModel::TYPE_USER_ROOT) {
                    ...
                    $form = $this->render('usuarios/form-by-type/edit/client/form', $data_form, false);
                } elseif ($type == UsersModel::TYPE_USER_EMPLOYEE) {

                    $form = $this->render('usuarios/form-by-type/edit/employee/form', $data_form, false);
                }
    ...
    public function formProfileByType(Request $req, Response $res, array $args)
    {
        ...
        if (!is_null($user->id)) {
            ...
            if ($type == UsersModel::TYPE_USER_ROOT) {
                ...
                $form = $this->render('usuarios/form-by-type/profile/client/form', $data_form, false);
            } elseif ($type == UsersModel::TYPE_USER_EMPLOYEE) {

                $form = $this->render('usuarios/form-by-type/profile/employee/form', $data_form, false);
            }
