        ...
        <div class="login-container">
            ...
            <div class="ui form login-form">
                ...
                <div class="actions" style="gap:15px">
                    ...
                    <a href="<?= $link_password ?>" class="ui fluid icon button">
                        <?= getIcon("refresh-outline") ?>
                        <?= strphrasecase($lang_dont_remember . " " . $lang_password) ?>
                    </a>

                    <a href="<?= $link_user ?>" class="ui fluid icon button">
                        <?= getIcon("person-circle-outline") ?>
                        <?= strphrasecase($lang_dont_remember . " " . $lang_user) ?>
                    </a>

                    <a href="<?= $link_blocked ?>" class="ui fluid icon button">
                        <?= getIcon("lock-closed-outline") ?>
                        <?= $lang_blocked_user ?>
                    </a>

                    <a href="<?= $link_other ?>" class="ui fluid icon button">
                        <?= getIcon("bug-outline") ?>
                        <?= $lang_other ?>
                    </a>

                    <a href="<?= $link_login ?>" class="ui primary fluid icon button">
                        <?= getIcon("log-in-outline") ?>
                        <?= $lang_login ?>
                    </a>
                </div>
