...
$permisosEmpleados = array_unique(array_merge($permisosGenerales, [
    //Por el momento solo permisos generales
]));
$permisosAdministrativos = array_unique(array_merge($permisosEmpleados, [
    //Usuarios
...
$config['roles']['types'] = [
    ...
    [
        'code' => UsersModel::TYPE_USER_EMPLOYEE,
        'name' => UsersModel::TYPES_USERS[UsersModel::TYPE_USER_EMPLOYEE],
        'all' => false,
        'allowed_routes' => $permisosEmpleados,
    ],
    [
        'code' => UsersModel::TYPE_USER_CLIENT,
        'name' => UsersModel::TYPES_USERS[UsersModel::TYPE_USER_CLIENT],
        'all' => false,
        'allowed_routes' => $permisosClientes,
    ],
];
