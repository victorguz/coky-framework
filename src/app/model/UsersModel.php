...
class UsersModel extends BaseEntityMapper
{
    ...
    const TYPE_USER_EMPLOYEE = 3;
    const TYPE_USER_CLIENT = 4;

    const TYPES_USERS = [
        self::TYPE_USER_ROOT => 'Usuario principal',
        self::TYPE_USER_ADMIN => 'Administrador',
        self::TYPE_USER_GENERAL => 'Usuario general',
        self::TYPE_USER_EMPLOYEE => 'Gerente de mantenimiento',
        self::TYPE_USER_CLIENT => 'Cliente',
    ];

    const TYPES_USER_PRIORITY = [
        self::TYPE_USER_ROOT => 4,
        self::TYPE_USER_ADMIN => 3,
        self::TYPE_USER_GENERAL => 2,
        self::TYPE_USER_EMPLOYEE => 1,
        self::TYPE_USER_CLIENT => 0,
    ];
